...
const NuevoPassword = () => {
  ...
  return (
    <div className='w-full'>
      ...
      {!valido && !alerta.error && (
        <div className='bg-white sm:p-8 p-4 rounded shadow-sm text-rose-500 flex items-center justify-center gap-2 border w-full text-lg text-center mb-10'>
          <svg
      ...
      {alerta.error && (
        <>
          ...
          <div className='bg-white py-5 px-10 rounded shadow-sm border text-center mt-10'>
            ...
            <Link to={'/registrar'} className='text-rose-500 hover:text-rose-600 transition-all'>
              Regístrate
            </Link>
          </div>
        </>
