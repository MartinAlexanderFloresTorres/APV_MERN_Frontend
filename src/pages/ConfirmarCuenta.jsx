  ...
  return (
    <>
      <div className='bg-white sm:p-10 p-6 rounded shadow-sm border mb-5 w-full'>
        <h1 className='text-rose-500 font-bold sm:text-5xl text-4xl text-center'>
          Confirmación de <span className='text-gray-700'>Cuenta</span>
        </h1>
      </div>

      {alerta.msg === '' ? (
        <div className='bg-white sm:p-8 p-4 rounded shadow-sm text-rose-500 flex items-center justify-center gap-2 border w-full text-lg text-center'>
          <svg
