  ...
  return (
    <div className='container md:p-10 p-5 flex items-center justify-center  flex-col gap-5 w-full lg:w-3/4 2xl:w-2/3 mx-auto'>
      <div className='text-center mt-10 pb-10'>
        ...
        <p className='text-xl'>
          Modifica tu <span className='text-rose-500 font-bold'>Información Aquí</span>
        </p>
      </div>
      ...
      >
        ...
        <div className='mb-5'>
          <label htmlFor='web' className='block uppercase text-gray-700 text-xl font-bold mb-2'>
            Sitio Web
          </label>
          <input
            className='border p-2 block bg-gray-50 rounded-md w-full outline-rose-200'
