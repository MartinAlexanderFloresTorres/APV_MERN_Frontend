...
const Search = () => {
  ...
  // usePacientes
  const { mostrar, setMostrar, setPaciente, pacientes, loading } = usePacientes()
  ...
  if (loading) {
    return (
      <div className='p-10 '>
        <div className='bg-white sm:p-8 p-4 rounded shadow-sm text-rose-500 flex items-center justify-center gap-2 border w-full lg:w-3/4 container mx-auto text-lg text-center my-10'>
          <svg
      ...
      <div className='w-full lg:w-3/4 container mx-auto'>
        <div className='p-10'>
          ...
          <div className='bg-white py-5 px-10 rounded shadow-sm border text-center mb-10 w-full'>
            <Link
              to={'/dashboard'}
              className='text-rose-500 hover:text-rose-600 transition-all font-semibold'
            >
  ...
  return (
    <div className='md:p-10 p-5 flex items-center justify-center  flex-col gap-5 w-full lg:w-3/4 container mx-auto'>
      <h2 className='font-bold text-4xl my-10'>
        Resultados de la busquedad: <span className='text-rose-500 font-bold'>{busqueda}</span>
      </h2>
      ...
      >
        <div className='w-full max-w-4xl lg:w-3/4  mx-auto'>
          <button
            ...
            className='ml-auto block font-black  cursor-pointer hover:bg-rose-600 bg-rose-500 text-white transition-all px-5 py-2 text-center rounded uppercase mb-10 '
          >
            Cerrar
          </button>
          <Formulario />
