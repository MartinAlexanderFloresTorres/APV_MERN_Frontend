    ...
    <div>
      <form onSubmit={handleSubmit} className='bg-white sm:p-10 p-6 rounded shadow-sm border mb-5'>
        <legend className='text-rose-500 font-bold sm:text-5xl text-4xl text-center mb-10'>
          Recupera tu Acceso y no Pierdas tus <span className='text-gray-700'>Pacientes</span>
        </legend>
        <div className='mb-5'>
          ...
          <input
            className='border p-2 block bg-gray-50 rounded-md w-full outline-rose-300'
            type='email'
            name='email'
            id='email'
            value={email}
        ...
        <ButtonLoad disabled={disabled || cargando} estado={cargando} type='submit'>
          {cargando ? 'Enviando enlace de recuperación...' : 'Enviar Enlace de Recuperación'}
        </ButtonLoad>
