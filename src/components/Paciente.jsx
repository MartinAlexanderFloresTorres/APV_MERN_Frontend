  ...
  return (
    <div className='my-2 bg-white p-5 shadow rounded-xl'>
      <p className='font-bold uppercase text-gray-700 mb-2'>
        <span className='border px-2 py-1 rounded-md inline-block text-[14px]'>Nombre:</span>{' '}
        <span className='font-normal normal-case break-all text-gray-800 text-sm'>{nombre}</span>
      </p>
      <p className='font-bold uppercase text-gray-700 mb-2'>
        <span className='border px-2 py-1 rounded-md inline-block text-[14px]'>Propietario:</span>{' '}
      ...
      <p className='font-bold uppercase text-gray-700 mb-2'>
        <span className='border px-2 py-1 rounded-md inline-block text-[14px]'>Fecha de Alta:</span>{' '}
        <span className='font-normal normal-case break-all text-gray-800 text-sm'>
          {formatearFecha(fechaAlta)}
        </span>
      </p>
      <p className='font-bold uppercase text-gray-700 mb-4'>
        <span className='border px-2 py-1 rounded-md inline-block text-[14px]'>Sintomas:</span>{' '}
        <span className='font-normal normal-case break-all text-gray-800 text-sm'>{sintomas}</span>
      </p>
