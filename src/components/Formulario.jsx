  ...
  return (
    <>
      ...
      >
        <div className="mb-5">
          <label
            className="mb-2 block text-gray-600 font-bold text-lg"
            htmlFor="nombre"
          >
            Nombre Mascota
          </label>
          <input
            className="border p-2 w-full placeholder-gray-400 outline-indigo-300 rounded-md"
            type="text"
            id="nombre"
            disabled={cargando}
            value={campos.nombre}
        ...
        <div className="mb-5">
          ...
          <textarea
            className="border p-2 w-full placeholder-gray-400 outline-indigo-300 rounded-md max-h-28"
            id="sintomas"
            name="sintomas"
            disabled={cargando}
